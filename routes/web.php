...
use App\Http\Controllers\CombinedPurchaseExitController;
...
use App\Http\Controllers\PurchaseExitController;
...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('purchase-requisitions/{id}/convert', [PurchaseRequisitionController::class, 'convert']);
    ...
    Route::get('/consumption-report', [ProductController::class, 'showConsumptionReport'])->name('consumption.report');
    ...
    //Reports...
    Route::get('/reports/user-accounting', [ReportController::class, 'getUserAccountingReport'])->name('report.user_accounting');
    ...
    Route::get('/reports/transferts-representative-report', [ReportController::class, 'getTransfertsRepresentativeReport']);
    ...
    Route::post('/purchase-exit/update', [CombinedPurchaseExitController::class, 'update']);

    Route::get('/purchase-exit/edit/{id}', [CombinedPurchaseExitController::class, 'edit']);
    Route::post('/purchase-exit/save', [CombinedPurchaseExitController::class, 'save']);
    Route::post('/purchase-exit/get_product_row', [CombinedPurchaseExitController::class, 'getProductRow']);
    Route::get('/purchase-exit/create', [CombinedPurchaseExitController::class, 'create']);
    ...
    Route::get('/purchase-exit/add/{id}', [PurchaseExitController::class, 'add']);
    Route::get('/purchase-exit/{id}', [PurchaseExitController::class, 'show']);

    Route::resource('/purchase-exit', PurchaseExitController::class)->except('create');
