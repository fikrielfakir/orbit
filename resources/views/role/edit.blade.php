...
<section class="content">
    ...
    @component('components.widget', ['class' => 'box-primary'])
        ...
        <div class="col-md-4">
        <div class="col-md-4">
    {!! Form::label('isDelivery', __( 'user.Is_Delivery' )) !!}
    <label class="switch">
        <!-- Check if 'isDelivery' is set to 1, if so, check the checkbox -->
        {!! Form::checkbox('isDelivery', 1, $role->isDelivery == 1, ['class' => 'sr-only']) !!}
