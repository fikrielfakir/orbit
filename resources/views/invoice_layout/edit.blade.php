      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            {!! Form::select('common_settings[num_to_word_format]', ['international' => __('lang_v1.international'), 'moroccan' => __('lang_v1.moroccan')], $invoice_layout->common_settings['num_to_word_format'] ?? 'international', ['class' => 'form-control', 'id' => 'word_format']); !!}
          </div>
        </div>
