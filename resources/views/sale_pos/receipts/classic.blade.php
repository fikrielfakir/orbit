    ...
    <body>
        <div class="ticket">
                ...
                <tbody>
                	@forelse($receipt_details->lines as $line)
	                    <tr>
	                        ...
	                        <td class="quantity text-right">{{ intval($line['quantity']) }}{{$line['units']}} @if($receipt_details->show_base_unit_details && $line['quantity'] && $line['base_unit_multiplier'] !== 1)
                            <br><small>
			...
			@if(empty($receipt_details->hide_price))
                ...
                <!-- Add return_amount -->
                @if($receipt_details->return_amount > 0)
                    <div class="flex-box">
                        <p class="width-50 text-right">Return Amount</p>
                        <p class="width-50 text-right">-{{ $receipt_details->return_amount }}</p>
                    </div>
                @endif
                <div class="flex-box">
					<p class="width-50 text-right sub-headings">
