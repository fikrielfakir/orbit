...
<body
    ...
    <div class="tw-flex">
        ...
        <input type="hidden" id="__code" value="{{ session('currency')['code'] ?? 'default_currency_code' }}">
        <input type="hidden" id="__symbol" value="{{ session('currency')['symbol'] ?? 'default_currency_symbol' }}">
        <input type="hidden" id="__thousand" value="{{ session('currency')['thousand_separator'] ?? ',' }}">
        <input type="hidden" id="__decimal" value="{{ session('currency')['decimal_separator'] ?? '.' }}">
        <input type="hidden" id="__symbol_placement" value="{{ session('business.currency_symbol_placement') ?? 'after' }}">
