<div class="table-responsive">
    <table class="table table-bordered table-striped ajax_view" id="purchase_exit_datatable">
        <thead>
            <tr>
        ...
        <tfoot>
            <tr class="bg-gray font-17 text-center footer-total">
                ...
                <td><span class="display_currency" id="footer_purchase_exit_total" data-currency_symbol ="true"></span></td>
