...
<div class="row">
    <div class="col-sm-12">
        @component('components.widget', ['class' => 'box-primary'])
            {!! Form::open(['url' => action([\App\Http\Controllers\ImportOpeningStockController::class, 'store']), 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'importForm' ]) !!}
                <div class="row">
                    <div class="col-sm-6">
                        <div class="col-sm-8">
                        ...
                        <div class="col-sm-4">
                            <br>
                            <button type="submit" class="tw-dw-btn tw-dw-btn-primary tw-text-white" id="submitButton">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <a href="{{ asset('files/import_opening_stock_csv_template.xls') }}" class="tw-dw-btn tw-dw-btn-success tw-text-white" download>
