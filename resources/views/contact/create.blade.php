    ...
    <div class="modal-body">
        <div class="row">            
            ...
            @endif
                 <div class="col-md-6">
<div class="form-group">
    <label for="refrigerators">الثلاجات</label>
    <div id="refrigerators-container">
        <div class="refrigerator-item">
            <input type="text" name="refrigerators[0][marque]" placeholder="ماركة الثلاجة" class="form-control">
            <input type="text" name="refrigerators[0][reference]" placeholder="مرجع الثلاجة" class="form-control">
        </div>
    </div>
    <button type="button" id="add-refrigerator" class="btn btn-primary">إضافة ثلاجة أخرى</button>
</div>
</div>
            <div class="clearfix"></div>
        </div>
...
<script>
    ...
    newItem.innerHTML = `
        <input type="text" name="refrigerators[${index}][marque]" placeholder="ماركة الثلاجة" class="form-control">
        <input type="text" name="refrigerators[${index}][reference]" placeholder="مرجع الثلاجة" class="form-control">
    `;
