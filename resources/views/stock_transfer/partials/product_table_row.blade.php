<tr class="product_row">
    ...
    <td>
        ...
        <input type="hidden" class="base_unit_multiplier" name="products[{{$row_index}}][base_unit_multiplier]" value="{{$multiplier}}">
         ...
         <input type="hidden" class="hidden_base_unit_price" value="{{$product->purchased_price}}">
    ...
    <td class="show_price_with_permission">
        <input type="text" name="products[{{$row_index}}][unit_price]" class="form-control product_unit_price input_number " value="{{@num_format($product->purchased_price)}}">
    </td>
    <td class="show_price_with_permission">
        <input type="text" readonly name="products[{{$row_index}}][price]" class="form-control product_line_total " value="{{@num_format($product->quantity_ordered*$product->purchased_price)}}">
    </td>
