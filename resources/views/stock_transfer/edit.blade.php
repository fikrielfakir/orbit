	...
	{!! Form::open(['url' => action([\App\Http\Controllers\StockTransferController::class, 'update'], [$sell_transfer->id]), 'method' => 'put', 'id' => 'stock_transfer_form' ]) !!}
		...
		@component('components.widget', ['class' => 'box-solid'])
			<div class="row">
				...
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('demandeur_id', __('Demandeur') . ':') !!}
						{!! Form::select('demandeur_id', $users, $sell_transfer->demandeur_id, ['class' => 'form-control select2', 'placeholder' => __('Select a requester'), 'style' => 'width: 100%;']); !!}
					</div>
				</div>
			</div>
		@endcomponent
