...
<div class="col-md-3">
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            {!! Form::select('added_by', $users, null, ['class' => 'form-control select2', 'id' => 'added_by', 'placeholder' => __('lang_v1.added_by')]); !!}
        </div>
    </div>
</div>
             <div class="col-md-3">
                            ...
                            id="product_sell_report_table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>@lang('report.charged_value')</th>
