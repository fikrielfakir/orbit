...
class BusinessLocation extends Model
{
    ...
    public static function forDropdownhasproduction($business_id, $show_all = false, $receipt_printer_type_attribute = false, $append_id = true, $check_permission = true)
    {
        $query = BusinessLocation::where('business_id', $business_id)->where('isfinal', 0)->Active();
