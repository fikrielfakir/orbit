...
class Transaction extends Model
{
    ...
    public static function transactionTypes()
    {
        return  [
            ...
            'exit_voucher' => __('lang_v1.exit_voucher'), // Added 'exit_voucher'
        ];
    }
...
// In App\Transaction.php
public function transfer_location()
{
    return $this->belongsTo(BusinessLocation::class, 'transfer_location_id');
}

public function purchase_transfer()
{
