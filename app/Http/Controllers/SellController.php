...
$walk_in_customer = $this->contactUtil->getWalkInCustomer($business_id) ?? [
    ...
    'supplier_business_name' => ''
        ...
        $users = config('constants.enable_contact_assign') ? User::forDropdownWithDelivery($business_id, false, false, false, true) : [];
...
public function show($id)
{
    ...
    $query = Transaction::where('business_id', $business_id)
                ...
                ->select('transactions.*', 'transactions.latitude', 'transactions.longitude'); // Include latitude and longitude
