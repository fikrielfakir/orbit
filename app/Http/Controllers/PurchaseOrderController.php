...
class PurchaseOrderController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $logowatermark = asset('uploads/invoice_logos/logowatermark.png');
        ...
        return view('purchase_order.show')
                ->with(compact('taxes', 'purchase','total_in_words','logo','logowatermark','purchase_taxes', 'activities', 'shipping_statuses', 'status_color_in_activity', 'po_statuses'));
    }
    ...
    public function downloadPdf($id)
    {
        ...
        $mpdf->SetTitle('BC-'.$purchase->ref_no.'.pdf');
        $mpdf->WriteHTML($body);
        $mpdf->Output('BC-'.$purchase->ref_no.'.pdf', 'I');
    }
