...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            // Handle the checkbox value for isDelivery
            $isDelivery = $request->input('isDelivery') == '1' ? 1 : 0;
            ...
            if ($count == 0) {
                ...
                $role = Role::create([
                    ...
                    'isDelivery' => $isDelivery,  // Store the isDelivery value
                ]);
                ...
                // Pass the permissions array to the method
