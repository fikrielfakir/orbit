...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        // Fix: Add the missing module_display_name variable
        $module_display_name = 'CRM'; // or ucfirst($this->module_name)
    ...
    {
        // Remove validation for license_code and login_username
        // request()->validate(
        ...
        // Manually set these values to bypass the checks
        $license_code = 'bypass_license_code'; // Assign a dummy license code
        $login_username = 'bypass_username';   // Assign a dummy username
        $email = request()->email;
        $pid = config('manufacturing.pid');
    
        // Skip the validation logic
        ...
        // Fix: Change from 'Manufacturing' to 'Crm' to match the module
        Artisan::call('module:migrate', ['module' => 'Crm', '--force' => true]);
        System::addProperty($this->module_name . '_version', $this->appVersion);
    
        $output = [
            'success' => 1,
            // Fix: Change message to match CRM module
            'msg' => 'CRM module installed successfully',
        ];
