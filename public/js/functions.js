...
function __currency_trans_from_en(
    ...
    var default_currency_symbol = typeof __currency_symbol !== 'undefined' ? __currency_symbol : 'MAD';
    var default_thousand_separator = typeof __currency_thousand_separator !== 'undefined' ? __currency_thousand_separator : ',';
    var default_decimal_separator = typeof __currency_decimal_separator !== 'undefined' ? __currency_decimal_separator : '.';

    // Page currency variables
    var page_currency_symbol = typeof __p_currency_symbol !== 'undefined' ? __p_currency_symbol : default_currency_symbol;
    var page_thousand_separator = typeof __p_currency_thousand_separator !== 'undefined' ? __p_currency_thousand_separator : default_thousand_separator;
    var page_decimal_separator = typeof __p_currency_decimal_separator !== 'undefined' ? __p_currency_decimal_separator : default_decimal_separator;

    var s, thousand, decimal;

    if (use_page_currency) {
        s = page_currency_symbol;
        thousand = page_thousand_separator;
        decimal = page_decimal_separator;
    } else {
        s = default_currency_symbol;
        thousand = default_thousand_separator;
    ...
    if (is_quantity) {
        precision = typeof __quantity_precision !== 'undefined' ? __quantity_precision : precision;
    }
