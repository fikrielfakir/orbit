...
product_sell_report = $('table#product_sell_report_table').DataTable({
    ...
    columns: [
        ...
        { data: 'current_stock', name: 'current_stock', searchable: false }, // Add Current Stock Column
        { data: 'charged_value', name: 'charged_value', searchable: false }, // Add Current Stock Column
        { data: 'added_by', name: 'added_by' }
        
    ],
    fnDrawCallback: function(oSettings) {
      // Calculate and update footer values
      $('#footer_subtotal').text(
        sum_table_col($('#product_sell_report_table'), 'subtotal')
    );
    $('#footer_total_sold').text(
        sum_table_col($('#product_sell_report_table'), 'sell_qty')
    );
    $('#footer_tax').text(
        sum_table_col($('#product_sell_report_table'), 'tax')
    );
    $('#footer_current_stock').text(
        sum_table_col($('#product_sell_report_table'), 'current_stock')
    );
    $('#footer_charged_value').text(
        sum_table_col($('#product_sell_report_table'), 'charged_value')
    );

    // Convert currency recursively
    ...
    items_report_table = $('#items_report_table').DataTable({
        ...
        fnDrawCallback: function(oSettings) {
            ...
            $('#footer_total_current_stock').html(sum_table_col($('#items_report_table'), 'current_stock'));
