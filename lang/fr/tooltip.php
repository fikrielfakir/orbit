<?php
 ...
 return [
     'product_stock_alert' => "Articles à faible stock. <br/> <small class = 'text-muted'> Basé sur la quantité d'alerte de article définie dans l'écran d'ajout de article. <br> Achetez ce article avant la fin du stock. </small>",
     ...
     'no_of_products_for_trending_products' => 'Nombre de articles de tendance à comparer dans le tableau ci-dessous.',
     'top_trending_products' => "Les articles les plus vendus de votre boutique. <br/> <small class = 'text-muted'> Appliquez des filtres pour connaître les articles tendance pour une catégorie spécifique, une marque, un lieu de travail, etc. </small>",
     'sku' => "Identifiant de article unique ou unité de gestion des stocks <br> <br> laissez-le vide pour générer automatiquement sku. <br> <small class = 'text-muted'> Vous pouvez modifier le préfixe sku dans les paramètres métier </small> ",
     'enable_stock' => 'Activer ou désactiver la gestion des stocks pour un article.',
     'alert_quantity' => "Soyez alerté lorsque le stock de articles atteint ou descend en dessous de la quantité spécifiée. <br> <br> <small class = 'text-muted'> Les articles avec un stock faible s'afficheront dans le tableau de bord - Section Alerte stock article. </small>",
     'product_type' => '<b> Article unique </b>: Article sans variations. <br> <b> Article variable </b>: Article avec des variations telles que la taille, la couleur, etc.',
     'profit_percent' => "Marge bénéficiaire par défaut pour le article. <br> <small class ='text-muted'> (<i> Vous pouvez gérer la marge bénéficiaire par défaut dans les paramètres d'entreprise. </small>",
     ...
     'order_status' => 'Les articles de cet achat ne seront disponibles à la vente que si <b> Statut de la commande </b> est <b> Articles reçus </b>.',
     'purchase_location' => "Emplacement de l'entreprise où le article acheté sera disponible à la vente.",
     ...
     'default_profit_percent' => "Marge bénéficiaire par défaut d'un article. <br> <small class = 'text-muted'> Utilisé pour calculer le prix de vente en fonction du prix d'achat saisi. <br/> Vous pouvez modifier cette valeur pour les articles individuels en ajoutant </small> ",
     ...
     'unit_allow_decimal' => 'Décimales vous permet de vendre les articles connexes en fractions.',
     'print_label' => 'Ajouter des articles -> Choisir les informations à afficher dans les étiquettes -> Sélectionner le réglage du code-barres -> Aperçu des étiquettes -> Imprimer',
